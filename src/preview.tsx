  ...
  return (
    <View
      style={{
        ...
        paddingTop: 150,
        gap: 20,
        flexDirection: props.orientation === "LANDSCAPE" ? "row" : "column",
      }}
    >
      <View
        style={{
          ...
          style={{
            height:
              props.cameraOrientation === "PORTRAIT"
                ? "100%"
                : props.photoAspectRatio === "1:1"
                  ? "100%"
                  : undefined,
            width:
              props.cameraOrientation === "LANDSCAPE"
                ? props.photoAspectRatio === "1:1"
                  ? undefined
                  : "100%"
                : undefined,
      ...
      <View
        style={{
          flex: props.orientation === "LANDSCAPE" ? 0.3 : 0.5,
          padding: 20,
      ...
      >
        ...
        {currentTab === "QR_CODE" ? <QrView {...props} /> : <WhatsappSend />}
      </View>
    </View>
  );
}