import { MD3LightTheme, MD3Theme, MD3TypescaleKey, configureFonts } from 'react-native-paper';
...
const theme: MD3Theme = {
  ...
  colors: {
    ...
    onPrimaryContainer: "#888686",
    secondary: "#865300",
    onSecondary: "#FFFFFF",
    secondaryContainer: "#FFA300",
    onSecondaryContainer: "#673F00",
    tertiary: "#585959",
    onTertiary: "#FFFFFF",
    tertiaryContainer: "#717171",
    onTertiaryContainer: "#F8F6F6",
    error: "#BC0100",
    onError: "#FFFFFF",
    errorContainer: "#EB0000",
